/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b45f34032154c470fedfcc855afabcde)
...
declare namespace Cloudflare {
	...
	interface Env {
		JWT_ISSUER: "https://macros-auth.jhonra121.workers.dev";
		JWT_AUDIENCE: "macros-convex-dev";
		JWT_KEY_ID: "macros-auth-dev-1";
		ASTRO_REDIRECT_URL: "https://macros-web.jhonra121.workers.dev/";
		CONVEX_BOOTSTRAP_URL: string;
		CONVEX_BOOTSTRAP_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_ISSUER" | "JWT_AUDIENCE" | "JWT_KEY_ID" | "ASTRO_REDIRECT_URL" | "CONVEX_BOOTSTRAP_URL" | "CONVEX_BOOTSTRAP_SECRET" | "JWT_PRIVATE_KEY_PKCS8" | "JWT_PUBLIC_JWKS">> {}
}
